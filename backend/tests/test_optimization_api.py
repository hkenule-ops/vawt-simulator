...
def test_optimize_pareto_front_endpoint(client):
    r = client.post("/api/v1/optimization/pareto-front", json={
        "geometry": SAMPLE_GEOMETRY, "material": "CFRP_UD", "ply_material": "CFRP_UD_PLY",
        "population_size": 12, "n_generations": 4, "seed": 1,
    })
...
def test_optimize_unknown_material_returns_400(client):
    r = client.post("/api/v1/optimization/pareto-front", json={
